  ...
  return (
    ...
    <div className="container mx-auto flex justify-between items-center py-4 px-6">
      ...
      <div className="hidden md:flex space-x-6">
        ...
        <Link to="/calculator" className="hover:text-yellow-300 transition duration-300 font-semibold">🌍 Calculator</Link>
    ...
    {isMobileMenuOpen && (
      <div className="md:hidden bg-green-800 text-white py-4 space-y-4 px-6">
        ...
        <Link to="/calculator" className="block hover:text-gray-300 font-semibold">🌍 Calculator</Link>
